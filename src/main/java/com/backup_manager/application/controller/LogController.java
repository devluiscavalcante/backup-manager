...
@Tag(name = "Logs", description = "Consulta de logs de backup")
public class LogController {
    ...
    @GetMapping("/warnings")
    @Operation(summary = "Retorna o conteúdo do warnings.log do último backup executado",
            description = "Identifica automaticamente o diretório do último backup realizado e retorna o conteúdo do warnings.log correspondente.")
